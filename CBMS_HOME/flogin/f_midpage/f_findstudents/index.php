...
<?php
  ...
  if(isset($_POST['INTEREST'])){
   $stmt = $pdo->query("SELECT * FROM STUDENT NATURAL JOIN STUDENT_INTEREST NATURAL JOIN STUDENT_PH_NO NATURAL JOIN student_email WHERE STUDENT_INTEREST.INTEREST='{$_POST['INTEREST']}' ORDER BY REG_NO");
...
<div class="container">
    <h2>Find Students with similar interest</h2>
    <form  method="post">
      <ul>
        <li>
      <div class="inputBox">
